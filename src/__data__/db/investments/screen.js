export const screen = [
  ...
  },
  {
    ...
    screens: [
      ...
      {
        path: "pfm/marketplace?marketPlaceId=duReadyStrategyRds",
        id: 6,
        title: "Доверительное управление",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
      ...
      {
        path: "pfm/marketplace?marketPlaceId=allIIS",
        id: 7,
      ...
      {
        path: "pfm/marketplace?marketPlaceId=iisCatalogRds",
        id: 8,
        title: "Витрина ИИС с продуктами",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
      ...
      {
        path: "pfm/marketplace?marketPlaceId=3pifCatalog",
        id: 9,
        title: "ЗПИФ",
        availableVersionFrom: "0.0",
        availableVersionTo: "14.5",
      ...
      {
        path: "pfm/marketplace?marketPlaceId=zpifCatalogRds",
        id: 10,
        title: "ЗПИФ",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
  ...
  },
  {
    ...
    screens: [
      ...
      {
        path: "brokerage/agreement/short?action=create",
        id: 4,
  ...
  },
  {
    ...
    screens: [
      ...
      {
        path: "pfm/marketplace?marketPlaceId=newItemRdsCatalog",
        id: 2,
        title: "Новинки",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
      ...
      {
        path: "pfm/marketplace?marketPlaceId=regularIncomeRdsCatalog",
        id: 4,
        title: "Регулярные выплаты",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
      ...
      {
        path: "pfm/marketplace?marketPlaceId=russianEconomyRdsCatalog",
        id: 6,
        title: "Российская экономика",
        availableVersionFrom: "14.6",
        availableVersionTo: "99.99",
  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        path: "",
        id: 2,
        title: "Фонд Коммерческая недвижимость",
        availableVersionFrom: "0.0",
        availableVersionTo: "99.99",
      },
      {
